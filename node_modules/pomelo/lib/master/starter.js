...
starter.sshrun = function(cmd, host, cb) {
  ...
  // cmd = "cd \"/home/heke/chatofpomelo-websocket/game-server\" && \"/usr/local/Cellar/node/5.0.0/bin/node\" \"/home/heke/chatofpomelo-websocket/game-server/app\" env=development  id=connector-server-1  host=120.24.76.150  port=4050  clientPort=3050  frontend=true  serverType=connector "
  // cmd = "cd \"/home/heke/chatofpomelo-websocket/game-server\" && \"node\" \"app\" env=development  id=connector-server-1  host=120.24.76.150  port=4050  clientPort=3050  frontend=true  serverType=connector "
  args.push(cmd);
